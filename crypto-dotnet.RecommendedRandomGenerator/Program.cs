...
namespace crypto_dotnet.RecommendedRandomGenerator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("hash= "+Convert.ToBase64String(hmacMd5Message));

            Console.WriteLine();
            Console.WriteLine("SHA1 HMAC");
            Console.WriteLine("hash= " + Convert.ToBase64String(hmacSha1Message));

            Console.WriteLine();
            Console.WriteLine("SHA256 HMAC");
            Console.WriteLine("hash= " + Convert.ToBase64String(hmacSha256Message));
